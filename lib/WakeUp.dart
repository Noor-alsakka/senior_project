...
class PreferencesSelectTime extends StatefulWidget {
  ...
  PreferencesSelectTime(this._title,
      this._timeOfDay,
      this._updateTimeFunction
      );

  @override
  PreferencesSelectTimeState createState() => PreferencesSelectTimeState(
      _title ,
      _timeOfDay,
      _updateTimeFunction
  );
...
class PreferencesSelectTimeState extends State<PreferencesSelectTime> {
  ...
  // TimeOfDay _timeOfDay;
  // Function _updateTimeFunction;
  PreferencesSelectTimeState(this._title, TimeOfDay timeOfDay,  updateTimeFunction,
      // this._timeOfDay, this._updateTimeFunction
      );
